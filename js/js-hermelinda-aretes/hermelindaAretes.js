      ...
      const btnAretes = document.querySelector(".contenedor-aretes__boton .boton-play-pause")
...
let tiempoCiclo;
      ...
      function togglePintarMamaCiclos() {
        if (check === 0) {
          pintarMamaCiclos();
          check = 1;
          btnAretes.innerHTML = '<img src="./imgs/btn-pause.svg  " alt="botón play"> ';
        } else {
          ...
          btnAretes.innerHTML = ' <img src="./imgs/btn-play.svg  " alt="botón play">';
        }
      }